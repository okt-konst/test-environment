...
static te_errno
rx_queues_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
indir_get(ta_conf_ctx *ctx, uintmax_t *val)
{
#ifndef ETHTOOL_GRSSH
    UNUSED(ctx);
    UNUSED(val);
...
static te_errno
indir_set(ta_conf_ctx *ctx, uintmax_t val)
{
#ifndef ETHTOOL_SRSSH
    UNUSED(ctx);
    UNUSED(val);
...
static te_errno
indir_default_get(ta_conf_ctx *ctx, uintmax_t *val)
{
#ifndef ETHTOOL_SRSSH
    UNUSED(ctx);
    UNUSED(val);
...
static te_errno
indir_default_set(ta_conf_ctx *ctx, uintmax_t val)
{
#ifndef ETHTOOL_SRSSH
    UNUSED(ctx);
    UNUSED(val);
...
static const ta_conf_node *const node_rss =
    TA_CONF_NA("rss",
        TA_CONF_RO_UINT("rx_queues", rx_queues_get),
        TA_CONF_LIST("context", rss_ctx_list,
            TA_CONF_NA_COMMIT("hash_indir", hash_indir_commit,
                ...
                TA_CONF_RW_COLL_UINT("indir", indir_get, indir_set,
                                     indir_list),
                TA_CONF_RW_UINT("indir_default", indir_default_get,
                                indir_default_set))));
