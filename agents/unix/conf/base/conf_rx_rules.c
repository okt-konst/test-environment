...
static te_errno
rules_last_added_get(ta_conf_ctx *ctx, intmax_t *val)
{
    const char *if_name = ta_conf_ctx_inst(ctx, "interface");
...
static te_errno
rules_table_size_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    const char *if_name = ta_conf_ctx_inst(ctx, "interface");
    ta_ethtool_rx_cls_rules *rules = NULL;
    te_errno rc;
...
static te_errno
rule_rss_context_get(ta_conf_ctx *ctx, intmax_t *val)
{
    const char *if_name = ta_conf_ctx_inst(ctx, "interface");
    const char *loc_str = ta_conf_ctx_inst(ctx, "rule");
...
static te_errno
rule_rss_context_set(ta_conf_ctx *ctx, intmax_t val)
{
    const char *if_name = ta_conf_ctx_inst(ctx, "interface");
    const char *loc_str = ta_conf_ctx_inst(ctx, "rule");
    ta_ethtool_rx_cls_rule *rule = NULL;
...
static te_errno
rule_rx_queue_get(ta_conf_ctx *ctx, intmax_t *val)
{
    const char *if_name = ta_conf_ctx_inst(ctx, "interface");
    const char *loc_str = ta_conf_ctx_inst(ctx, "rule");
    ta_ethtool_rx_cls_rule *rule = NULL;
...
static te_errno
rule_rx_queue_set(ta_conf_ctx *ctx, intmax_t val)
{
    const char *if_name = ta_conf_ctx_inst(ctx, "interface");
    const char *loc_str = ta_conf_ctx_inst(ctx, "rule");
    ta_ethtool_rx_cls_rule *rule = NULL;
...
static const ta_conf_node *const node_rules =
    TA_CONF_NA("rx_rules",
        TA_CONF_RO_UINT("table_size", rules_table_size_get),
        TA_CONF_RO_BOOL("spec_loc", rules_spec_loc_get),
        TA_CONF_RO_INT("last_added", rules_last_added_get),
        TA_CONF_NODE((.name = "rule",
                      .add = { .as_none = rule_add },
                      .del = rule_del,
                      .list = rules_list,
                      .commit = rule_commit),
            TA_CONF_RW_INT("rx_queue", rule_rx_queue_get,
                           rule_rx_queue_set),
            TA_CONF_RW_INT("rss_context", rule_rss_context_get,
