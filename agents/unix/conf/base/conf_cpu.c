...
cpu_cache_get_value(const char *node_str, const char *package_str,
                    ...
                    uintmax_t *val, cache_item_field field)
{
    cache_item *cache = NULL;
    ...
    copy_cache_item_field(cache, val, field);
...
static te_errno
cpu_core_cache_level_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
cpu_package_cache_level_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    te_errno rc = TE_EOPNOTSUPP;
...
static te_errno
cpu_core_cache_linesize_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    te_errno rc = TE_EOPNOTSUPP;
...
static te_errno
cpu_package_cache_linesize_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    te_errno rc = TE_EOPNOTSUPP;
...
static te_errno
cpu_core_cache_size_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    te_errno rc = TE_EOPNOTSUPP;
...
static te_errno
cpu_package_cache_size_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    te_errno rc = TE_EOPNOTSUPP;
...
static te_errno
cpu_core_cache_assoc_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    te_errno rc = TE_EOPNOTSUPP;
...
static te_errno
cpu_package_cache_assoc_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    te_errno rc = TE_EOPNOTSUPP;
...
static te_errno
memory_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    uint64_t mem = 0;
...
static te_errno
avail_memory_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    ...
    TA_CONF_LIST("node", numa_list,
        TA_CONF_LIST("cpu", cpu_list,
            TA_CONF_RO_COLL("cache", cpu_package_cache_type_get,
                ...
                TA_CONF_RO_UINT("level", cpu_package_cache_level_get),
                TA_CONF_RO_UINT("linesize", cpu_package_cache_linesize_get),
                TA_CONF_RO_UINT("size", cpu_package_cache_size_get),
                TA_CONF_RO_UINT("assoc", cpu_package_cache_assoc_get)),
            TA_CONF_LIST("core", cpu_core_list,
                ...
                TA_CONF_RO_COLL("cache", cpu_core_cache_type_get,
                                cpu_core_cache_list,
                    TA_CONF_RO_UINT("level", cpu_core_cache_level_get),
                    TA_CONF_RO_UINT("linesize", cpu_core_cache_linesize_get),
                    TA_CONF_RO_UINT("size", cpu_core_cache_size_get),
                    TA_CONF_RO_UINT("assoc", cpu_core_cache_assoc_get)))),
        TA_CONF_RO_UINT("memory", memory_get,
            TA_CONF_RO_UINT("free", avail_memory_get)));
