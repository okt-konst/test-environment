...
static te_errno
pci_sriov_num_vfs_get(ta_conf_ctx *ctx, intmax_t *val)
{
    const char *addr_str = ta_conf_ctx_inst(ctx, "device");
    te_errno rc;
    int result;
...
static te_errno
pci_sriov_num_vfs_set(ta_conf_ctx *ctx, intmax_t val)
{
    const char *addr_str = ta_conf_ctx_inst(ctx, "device");
    const pci_device *dev;
    te_errno rc;
...
static te_errno
pci_sriov_get(ta_conf_ctx *ctx, intmax_t *val)
{
    const char *addr_str = ta_conf_ctx_inst(ctx, "device");
    te_errno rc;
    int result;
...
static te_errno
param_drv_specific_get(ta_conf_ctx *ctx, intmax_t *val)
{
#ifndef USE_LIBNETCONF
    UNUSED(ctx);
    ...
    TA_CONF_NA("pci",
        TA_CONF_LIST("device", pci_device_list,
            ...
            TA_CONF_LIST("param", pci_param_list,
                TA_CONF_RO_INT("driver_specific", param_drv_specific_get),
