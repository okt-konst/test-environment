...
static te_errno
vxlan_add(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
geneve_add(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
vxlan_vni_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
vxlan_vni_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
geneve_vni_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
geneve_vni_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
vxlan_port_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
vxlan_port_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
geneve_port_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
geneve_port_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
vxlan_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
vxlan_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
geneve_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
geneve_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static const ta_conf_node *const node_tunnel =
    TA_CONF_NA("tunnel",
        TA_CONF_COLL_UINT0_RW_COMMIT("vxlan", vxlan_get, vxlan_set,
                                     vxlan_add, vxlan_del, vxlan_list,
                                     vxlan_commit,
            TA_CONF_RW_STR("dev", vxlan_dev_get, vxlan_dev_set),
            TA_CONF_RW_UINT0("port", vxlan_port_get, vxlan_port_set),
            TA_CONF_RW_STR("local", vxlan_local_get, vxlan_local_set),
            TA_CONF_RW_STR("remote", vxlan_remote_get,
                           vxlan_remote_set),
            TA_CONF_RW_UINT0("vni", vxlan_vni_get, vxlan_vni_set)),
        TA_CONF_COLL_UINT0_RW_COMMIT("geneve", geneve_get, geneve_set,
                                     geneve_add, geneve_del, geneve_list,
                                     geneve_commit,
            TA_CONF_RW_UINT0("port", geneve_port_get, geneve_port_set),
            TA_CONF_RW_STR("remote", geneve_remote_get,
                           geneve_remote_set),
            TA_CONF_RW_UINT0("vni", geneve_vni_get, geneve_vni_set)));
