 ...
 */
static te_errno
sun_ioctl_get_int(char *drv, char *param, intmax_t *val)
{
    ...
    return te_strtoimax(strval, 10, val);
}
 ...
 */
static te_errno
sun_ioctl_set_int(char *drv, char *param, intmax_t val)
{
    char strval[RCF_MAX_VAL] = "";

    snprintf(strval, sizeof(strval), "%jd", val);
 ...
 */
static te_errno
proc_sys_common_get(const char *path, intmax_t *val)
{
    int      bmem = 0;
    te_errno rc;
 ...
 */
static te_errno
proc_sys_common_set(const char *path, intmax_t val)
{
    int      bmem = 0;
    te_errno rc;
...
static te_errno                                                       \
_name##_get(ta_conf_ctx *ctx, intmax_t *val)                          \
{                                                                      \
    UNUSED(ctx);                                                      \
    UNUSED(val);                                                      \
    return IF_LINUX_COMMON_GET(_path);                                \
                                                                        ...
                                                                        \
static te_errno                                                       \
_name##_set(ta_conf_ctx *ctx, intmax_t val)                           \
{                                                                      \
    UNUSED(ctx);                                                      \
    UNUSED(val);                                                      \
 ...
 */
static te_errno
sndbuf_max_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem = 0;
 ...
 */
static te_errno
sndbuf_max_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem;
 ...
 */
static te_errno
sndbuf_def_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem = 0;
 ...
 */
static te_errno
sndbuf_def_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem;
 ...
 */
static te_errno
rcvbuf_max_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem = 0;
 ...
 */
static te_errno
rcvbuf_max_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem;
 ...
 */
static te_errno
rcvbuf_def_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem = 0;
 ...
 */
static te_errno
rcvbuf_def_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem;
 ...
 */
static te_errno
tcp_sndbuf_max_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
tcp_sndbuf_max_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
tcp_sndbuf_def_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
tcp_sndbuf_def_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
tcp_rcvbuf_max_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
tcp_rcvbuf_max_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
tcp_rcvbuf_def_get(ta_conf_ctx *ctx, intmax_t *val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
tcp_rcvbuf_def_set(ta_conf_ctx *ctx, intmax_t val)
{
    te_errno  rc = 0;
#if __linux__
    int       bmem[3] = { 0, };
 ...
 */
static te_errno
udp_sndbuf_max_get(ta_conf_ctx *ctx, intmax_t *val)
{
#if __linux__
 ...
 */
static te_errno
udp_sndbuf_max_set(ta_conf_ctx *ctx, intmax_t val)
{
#if __linux__
 ...
 */
static te_errno
udp_sndbuf_def_get(ta_conf_ctx *ctx, intmax_t *val)
{
#if __linux__
 ...
 */
static te_errno
udp_sndbuf_def_set(ta_conf_ctx *ctx, intmax_t val)
{
#if __linux__
 ...
 */
static te_errno
udp_rcvbuf_max_get(ta_conf_ctx *ctx, intmax_t *val)
{
#if __linux__
 ...
 */
static te_errno
udp_rcvbuf_max_set(ta_conf_ctx *ctx, intmax_t val)
{
#if __linux__
 ...
 */
static te_errno
udp_rcvbuf_def_get(ta_conf_ctx *ctx, intmax_t *val)
{
#if __linux__
 ...
 */
static te_errno
udp_rcvbuf_def_set(ta_conf_ctx *ctx, intmax_t val)
{
#if __linux__
...
static const ta_conf_node *const node_sys =
    TA_CONF_NA("sys",
        TA_CONF_RW_INT("sndbuf_max", sndbuf_max_get, sndbuf_max_set),
        TA_CONF_RW_INT("sndbuf_def", sndbuf_def_get, sndbuf_def_set),
        TA_CONF_RW_INT("rcvbuf_max", rcvbuf_max_get, rcvbuf_max_set),
        TA_CONF_RW_INT("rcvbuf_def", rcvbuf_def_get, rcvbuf_def_set),
        TA_CONF_RW_INT("route_mtu_expires", route_mtu_expires_get,
                       route_mtu_expires_set),
        TA_CONF_RW_INT("tcp_timestamps",
                       tcp_timestamps_get, tcp_timestamps_set),
        TA_CONF_RW_INT("tcp_syncookies",
                       tcp_syncookies_get, tcp_syncookies_set),
        TA_CONF_RW_INT("tcp_fin_timeout", tcp_fin_timeout_get,
                       tcp_fin_timeout_set),
        TA_CONF_RW_INT("tcp_orphan_retries", tcp_orphan_retries_get,
                       tcp_orphan_retries_set),
        TA_CONF_RW_INT("tcp_retries2", tcp_retries2_get, tcp_retries2_set),
        TA_CONF_RW_INT("tcp_keepalive_intvl", tcp_keepalive_intvl_get,
                       tcp_keepalive_intvl_set),
        TA_CONF_RW_INT("tcp_keepalive_probes", tcp_keepalive_probes_get,
                       tcp_keepalive_probes_set),
        TA_CONF_RW_INT("tcp_keepalive_time", tcp_keepalive_time_get,
                       tcp_keepalive_time_set),
        TA_CONF_RW_INT("tcp_syn_retries", tcp_syn_retries_get,
                       tcp_syn_retries_set),
        TA_CONF_RW_INT("tcp_synack_retries", tcp_synack_retries_get,
                       tcp_synack_retries_set),
        TA_CONF_RW_INT("igmp_max_memberships", igmp_max_memberships_get,
                       igmp_max_memberships_set),
        TA_CONF_RW_INT("optmem_max", optmem_max_get, optmem_max_set),
        TA_CONF_RW_INT("somaxconn", somaxconn_get, somaxconn_set),
        TA_CONF_RW_INT("busy_poll", busy_poll_get, busy_poll_set),
        TA_CONF_RW_INT("busy_read", busy_read_get, busy_read_set),
        TA_CONF_RW_INT("neigh_gc_thresh3", neigh_gc_thresh3_get,
                       neigh_gc_thresh3_set),
        TA_CONF_RW_INT("tcp_max_syn_backlog", tcp_max_syn_backlog_get,
                       tcp_max_syn_backlog_set),
        TA_CONF_RW_INT("tcp_sndbuf_max",
                       tcp_sndbuf_max_get, tcp_sndbuf_max_set),
        TA_CONF_RW_INT("tcp_sndbuf_def",
                       tcp_sndbuf_def_get, tcp_sndbuf_def_set),
        TA_CONF_RW_INT("tcp_rcvbuf_max",
                       tcp_rcvbuf_max_get, tcp_rcvbuf_max_set),
        TA_CONF_RW_INT("tcp_rcvbuf_def",
                       tcp_rcvbuf_def_get, tcp_rcvbuf_def_set),
        TA_CONF_RW_INT("udp_sndbuf_max",
                       udp_sndbuf_max_get, udp_sndbuf_max_set),
        TA_CONF_RW_INT("udp_sndbuf_def",
                       udp_sndbuf_def_get, udp_sndbuf_def_set),
        TA_CONF_RW_INT("udp_rcvbuf_max",
