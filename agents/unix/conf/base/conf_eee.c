...
static te_errno
eee_active_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    return common_field_get(ctx, val, FIELD_EEE_ACTIVE);
}

/* Get eee_enabled field */
static te_errno
eee_enabled_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    return common_field_get(ctx, val, FIELD_EEE_ENABLED);
}

/* Get tx_lpi_enabled field */
static te_errno
tx_lpi_enabled_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
static te_errno
tx_lpi_timer_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    return common_field_get(ctx, val, FIELD_TX_LPI_TIMER);
}

/* Set eee_enabled field */
static te_errno
eee_enabled_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
tx_lpi_enabled_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static te_errno
tx_lpi_timer_set(ta_conf_ctx *ctx, uintmax_t val)
{
...
static const ta_conf_node *const node_eee =
    TA_CONF_NA_COMMIT("eee", eee_commit,
        TA_CONF_RO_UINT("eee_active", eee_active_get),
        TA_CONF_RW_UINT("eee_enabled", eee_enabled_get, eee_enabled_set),
        TA_CONF_RW_UINT("tx_lpi_enabled", tx_lpi_enabled_get,
                        tx_lpi_enabled_set),
        TA_CONF_RW_UINT("tx_lpi_timer", tx_lpi_timer_get, tx_lpi_timer_set));
