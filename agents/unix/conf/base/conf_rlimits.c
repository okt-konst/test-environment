...
static te_errno
rlimit_nofile_cur_get(ta_conf_ctx *ctx, uintmax_t *value)
{
    UNUSED(ctx);
...
static te_errno
rlimit_nofile_cur_set(ta_conf_ctx *ctx, uintmax_t value)
{
    UNUSED(ctx);
...
static te_errno
rlimit_nofile_max_get(ta_conf_ctx *ctx, uintmax_t *value)
{
    UNUSED(ctx);
...
static te_errno
rlimit_nofile_max_set(ta_conf_ctx *ctx, uintmax_t value)
{
    UNUSED(ctx);
...
static te_errno
rlimit_memlock_cur_get(ta_conf_ctx *ctx, uintmax_t *value)
{
    UNUSED(ctx);
...
static te_errno
rlimit_memlock_cur_set(ta_conf_ctx *ctx, uintmax_t value)
{
    UNUSED(ctx);
...
static te_errno
rlimit_memlock_max_get(ta_conf_ctx *ctx, uintmax_t *value)
{
    UNUSED(ctx);
...
static te_errno
rlimit_memlock_max_set(ta_conf_ctx *ctx, uintmax_t value)
{
    UNUSED(ctx);
...
static const ta_conf_node *const node_rlimits =
    TA_CONF_NA("rlimits",
        TA_CONF_NA("nofile",
            TA_CONF_RW_UINT("cur", rlimit_nofile_cur_get,
                            rlimit_nofile_cur_set),
            TA_CONF_RW_UINT("max", rlimit_nofile_max_get,
                            rlimit_nofile_max_set)),
        TA_CONF_NA("memlock",
            TA_CONF_RW_UINT("cur", rlimit_memlock_cur_get,
                            rlimit_memlock_cur_set),
            TA_CONF_RW_UINT("max", rlimit_memlock_max_get,
