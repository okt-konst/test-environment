...
static intmax_t demo_int;
static uintmax_t demo_uint;
static uintmax_t demo_hex;
static uintmax_t demo_uint0;
...
static uintmax_t demo_grp_a, demo_grp_b;          /* committed */
static uintmax_t demo_grp_a_new, demo_grp_b_new;  /* staged */
static uintmax_t demo_commits;
...
static te_errno
demo_int_get(ta_conf_ctx *ctx, intmax_t *val)
{
    UNUSED(ctx);
    *val = demo_int;
    return 0;
...
static te_errno
demo_int_set(ta_conf_ctx *ctx, intmax_t val)
{
    UNUSED(ctx);
    demo_int = val;
    return 0;
...
static te_errno
demo_uint_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
    *val = demo_uint;
    return 0;
...
static te_errno
demo_uint_set(ta_conf_ctx *ctx, uintmax_t val)
{
    UNUSED(ctx);
    demo_uint = val;
    return 0;
...
static te_errno
demo_hex_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
    *val = demo_hex;
    return 0;
...
static te_errno
demo_hex_set(ta_conf_ctx *ctx, uintmax_t val)
{
    UNUSED(ctx);
    demo_hex = val;
    return 0;
...
static te_errno
demo_uint0_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
    *val = demo_uint0;
    return 0;
...
static te_errno
demo_uint0_set(ta_conf_ctx *ctx, uintmax_t val)
{
    UNUSED(ctx);
    demo_uint0 = val;
    return 0;
 ...
 * value of their own, with a RO_UINT child echoing the instance's
...
static te_errno
demo_fixed_index_get(ta_conf_ctx *ctx, uintmax_t *val)
{
...
/*
 * "cell": TA_CONF_RO_COLL_INT -- fixed instances with signed values,
...
static te_errno
demo_cell_get(ta_conf_ctx *ctx, intmax_t *val)
{
...
/*
 * "dial": TA_CONF_RW_COLL_UINT -- a fixed 2-entry table of settable
 * values; instances are enumerable but not created/destroyed through
 * this node (no add/del).
 */
static uintmax_t demo_dial_x, demo_dial_y;
...
static te_errno
demo_dial_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    const char *name = ta_conf_ctx_inst(ctx, "dial");
    uintmax_t *p = demo_dial_find(name);
...
static te_errno
demo_dial_set(ta_conf_ctx *ctx, uintmax_t val)
{
    const char *name = ta_conf_ctx_inst(ctx, "dial");
    uintmax_t *p = demo_dial_find(name);
...
static uintmax_t demo_citem_commits;
...
static te_errno
demo_citem_commits_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
...
static uintmax_t demo_batch_commits;
...
static te_errno
demo_batch_commits_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
...
static te_errno
demo_grp_a_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
    *val = demo_grp_a;
    return 0;
...
static te_errno
demo_grp_a_set(ta_conf_ctx *ctx, uintmax_t val)
{
    UNUSED(ctx);
    demo_grp_a_new = val;
    return 0;
...
static te_errno
demo_grp_b_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
    *val = demo_grp_b;
    return 0;
...
static te_errno
demo_grp_b_set(ta_conf_ctx *ctx, uintmax_t val)
{
    UNUSED(ctx);
    demo_grp_b_new = val;
    return 0;
...
static te_errno
demo_commits_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    UNUSED(ctx);
    *val = demo_commits;
    return 0;
...
static const ta_conf_node *const demo_grp_tree =
    TA_CONF_NA_COMMIT("grp", demo_grp_commit,
        TA_CONF_RW_UINT("a", demo_grp_a_get, demo_grp_a_set),
        TA_CONF_RW_UINT("b", demo_grp_b_get, demo_grp_b_set),
        TA_CONF_RO_UINT("commits", demo_commits_get));
...
static const ta_conf_node *const demo_fixed_tree =
    TA_CONF_LIST("fixed", demo_fixed_list,
        TA_CONF_RO_UINT("index", demo_fixed_index_get));
...
static const ta_conf_node *const demo_tree =
    TA_CONF_NA("ta_conf_demo",
        ...
        TA_CONF_RW_INT("int_val", demo_int_get, demo_int_set),
        TA_CONF_RW_UINT("uint_val", demo_uint_get, demo_uint_set),
        TA_CONF_RW_HEX32("hex_val", demo_hex_get, demo_hex_set),
        TA_CONF_RW_UINT0("uint0_val", demo_uint0_get, demo_uint0_set),
        ...
        demo_fixed_tree,
        TA_CONF_RO_COLL_INT("cell", demo_cell_get, demo_cell_list),
        TA_CONF_RW_COLL_UINT("dial", demo_dial_get, demo_dial_set,
                             demo_dial_list),
        ...
        TA_CONF_RO_UINT("citem_commits", demo_citem_commits_get),
        TA_CONF_NODE((.name = "batch",
                      .add = { .as_none = demo_batch_add },
                      .del = demo_batch_del,
                      .list = demo_batch_list,
                      .commit = demo_batch_commit)),
        TA_CONF_RO_UINT("batch_commits", demo_batch_commits_get),
        demo_grp_tree);
