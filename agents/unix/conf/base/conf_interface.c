...
static te_errno ifindex_get(ta_conf_ctx *ctx, uintmax_t *val);
...
static te_errno min_mtu_get(ta_conf_ctx *ctx, uintmax_t *val);
static te_errno max_mtu_get(ta_conf_ctx *ctx, uintmax_t *val);
...
static te_errno neigh_state_get(ta_conf_ctx *ctx, uintmax_t *val);
...
static const ta_conf_node *const node_interface =
    TA_CONF_LIST("interface", interface_list,
        ...
        TA_CONF_RO_UINT("index", ifindex_get),
        ...
        TA_CONF_RO_UINT("min_mtu", min_mtu_get),
        TA_CONF_RO_UINT("max_mtu", max_mtu_get),
        ...
        TA_CONF_COLL_STR_RW("neigh_dynamic", neigh_dynamic_get,
            ...
            TA_CONF_RO_UINT("state", neigh_state_get)));
 ...
 */
static te_errno
ifindex_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    const char  *ifname = ta_conf_ctx_inst(ctx, "interface");
 ...
 * code instead of becoming TA_CONF_TYPE_ENUM, to preserve that
 * fallback exactly.
 */
static te_errno
 ...
 */
static te_errno
min_mtu_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    const char *ifname = ta_conf_ctx_inst(ctx, "interface");
    te_errno    rc;
#ifdef USE_LIBNETCONF
 ...
 */
static te_errno
max_mtu_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    const char *ifname = ta_conf_ctx_inst(ctx, "interface");
    te_errno    rc;
#ifdef USE_LIBNETCONF
 ...
 */
static te_errno
neigh_state_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    const char  *ifname = ta_conf_ctx_inst(ctx, "interface");
