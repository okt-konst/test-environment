...
static te_errno                                                       \
net_if_stats_##_name_##_get(ta_conf_ctx *ctx, uintmax_t *val)         \
{                                                                     \
...
#define STATS_NET_IF_NODE_(n_) \
    TA_CONF_RO_UINT(#n_, net_if_stats_##n_##_get),
...
#define STATS_NET_SNMP_ICMP_NODE_(n_) \
    TA_CONF_RO_UINT("icmp_" #n_, net_snmp_icmp_stats_##n_##_get),

#define STATS_NET_SNMP_IPV4_NODE_(n_) \
    TA_CONF_RO_UINT("ipv4_" #n_, net_snmp_ipv4_stats_##n_##_get),
