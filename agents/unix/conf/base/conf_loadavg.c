...
static te_errno
loadavg_latest_pid_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static te_errno
loadavg_total_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static te_errno
loadavg_runnable_get(ta_conf_ctx *ctx, uintmax_t *val)
{
    loadavg_stats stats;
    te_errno rc;
...
static const ta_conf_node *const node_loadavg =
    TA_CONF_NA("loadavg",
        ...
        TA_CONF_RO_UINT("runnable", loadavg_runnable_get),
        TA_CONF_RO_UINT("total", loadavg_total_get),
        TA_CONF_RO_UINT("latest_pid", loadavg_latest_pid_get));
